...
/**
 * Servlet implementation class adminCatalogBrowsing
 */
@WebServlet("/adminCatalogBrowsing")
public class adminCatalogBrowsing extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public adminCatalogBrowsing() {
		super();
	...
	private void processAcCs(HttpServletRequest request,
		...
		try {
			getServletContext().getRequestDispatcher("/admins_courses.jsp").forward(request, response);
	...
	private void processMajorsByDepartment(HttpServletRequest request,
		...
		catch(NoResultException e)
		{
			...
			try 
			{
				getServletContext().getRequestDispatcher("/adminmajors_list.jsp").forward(request, response);
			} 
