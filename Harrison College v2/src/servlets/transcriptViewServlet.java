...
/**
 * Servlet implementation class transcriptViewServlet
 */
@WebServlet("/transcriptViewServlet")
public class transcriptViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public transcriptViewServlet() {
        super();
	...
	public void listDB(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		long stid=(long) session.getAttribute("userid");
