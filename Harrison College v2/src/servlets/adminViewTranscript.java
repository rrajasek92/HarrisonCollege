...
/**
 * Servlet implementation class adminViewTranscript
 */
@WebServlet("/adminViewTranscript")
public class adminViewTranscript extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminViewTranscript() {
        super();
